...
public class Employee {
    ...
    static List<Employee> getData(){
        return  Arrays.asList(
                new Employee(1, "John", "Doe", 28, 50000.0, Department.IT, false, LocalDate.of(2015, 5, 1), "john.doe@example.com", "1234567890", Position.JUNIOR, "123 Main St"),
                new Employee(2, "Jane", "Smith", 35, 60000.0, Department.HR, true, LocalDate.of(2010, 3, 15), "jane.smith@example.com", "0987654321", Position.MANAGER, "456 Elm St"),
                new Employee(3, "Mary", "Johnson", 45, 75000.0, Department.IT, true, LocalDate.of(2005, 8, 20), "mary.johnson@example.com", "1122334455", Position.SENIOR, "789 Oak St"),
                new Employee(4, "James", "Brown", 22, 40000.0, Department.SALES, false, LocalDate.of(2020, 2, 10), "james.brown@example.com", "6677889900", Position.INTERN, "101 Maple St"),
                new Employee(5, "Patricia", "Williams", 30, 55000.0, Department.MARKETING, false, LocalDate.of(2013, 6, 5), "patricia.williams@example.com", "3344556677", Position.JUNIOR, "202 Pine St"),
                new Employee(6, "Michael", "Jones", 40, 80000.0, Department.FINANCE, true, LocalDate.of(2008, 11, 25), "michael.jones@example.com", "9988776655", Position.DIRECTOR, "303 Cedar St"),
    ...
    public static double getAverageSalary() {
        ...
        return getData().stream()
                ...
                .reduce(0.0, (a, b) -> a + b)/(getData().size());
    }
    ...
    static Employee copyEmployee(Employee employee) {
        return new Employee(
                getData().indexOf(employee)+1,
                employee.getName(),
                employee.getSurname(),
                employee.getAge(),
                employee.getSalary(),
                employee.getDepartment(),
                employee.getIsEmployer(),
    ...
    static List<Employee> deepCopy() {
        return getData().stream()
                .map(Employee::copyEmployee)
                .toList();
    }
}
